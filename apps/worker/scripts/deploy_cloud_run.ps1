...
& gcloud run deploy $SERVICE `
    ...
    --timeout 3600 `
    --no-cpu-throttling `
    --set-env-vars "ENV=production,LOG_LEVEL=INFO,SENTRY_ENVIRONMENT=production,FEATURE_REAL_LLM=true,FEATURE_PAPER_EXECUTION=true,FEATURE_LIVE_TRADING=false,FEATURE_FCM_PUSH=true,FEATURE_EMAIL_NOTIFY=true,GCS_BUCKET_RAW=tessera-raw,LLM_MAX_DAILY_COST_USD=5.0,LLM_MAX_DAILY_COST_CHAT_USD=2.0,ALPACA_BASE_URL=https://paper-api.alpaca.markets,RELY_ON_IAM=true" `
